...
// datastruct provides common datastructures for programming such as Arrays , LinkedLists , Maps , Stack and Queues
// This package use functional programming concepts extensively, making working with arrays every much more
// easy than arrays and slices provided by Go.
